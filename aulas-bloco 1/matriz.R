...
#
#byrow matriz será preenchida por linha, primeira linha depois pula pra segunda
matriz <- matrix(c(1,5,10,30,15,8),nrow=3,ncol=2,byrow=TRUE)
print(matriz)

#preenche por coluna primeiro
...
#pega um intervalo com os numeros 2 a 9, com 2 colunas
...
#criando e estabelecendo parâmetros para a matriz
